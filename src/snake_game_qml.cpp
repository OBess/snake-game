...
SnakeGameQml::SnakeGameQml(QObject *parent)
    : QObject(parent)
{
    // Reads saved data
...
void SnakeGameQml::onAppStateEvent(Qt::ApplicationState state)
{
#ifdef Q_OS_ANDROID
...
//void SnakeGameQml::keyPressEvent(QKeyEvent *event)
//{
//#ifndef Q_OS_ANDROID
//    if (_gameLogic->doesGameGoOn())
//    {
...
//void SnakeGameQml::mousePressEvent(QMouseEvent *event)
//{
//#ifdef Q_OS_ANDROID
...
//void SnakeGameQml::mouseMoveEvent(QMouseEvent *event)
//{
//#ifdef Q_OS_ANDROID
...
void SnakeGameQml::timerEvent(QTimerEvent *event)
{
    _gameLogic->update();
    _score->update();
...
void SnakeGameQml::setupUI()
{
    setWindowTitle("SnakeGameQml");
...
void SnakeGameQml::setup(unsigned &bestScore, QSize &area)
{
